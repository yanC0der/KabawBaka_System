...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Get product details
    $product_sql = "SELECT price, stock, product_name FROM products WHERE product_id = ?";
    ...
    // Insert order directly (Buy Now bypasses cart)
    $order_sql = "INSERT INTO orders (buyer_id, product_id, quantity, total_price, status) VALUES (?, ?, ?, ?, 'Confirmed')";
